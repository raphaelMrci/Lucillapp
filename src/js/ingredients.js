...
storage.has( 'ingredients', function ( error, hasKey ) {
    ...
    if ( !hasKey ) {
        ...
        storage.set( 'ingredients', defaultIngredients );
...
ingredients = storage.getSync( 'ingredients' );
let deleteID;
...
deleteBtn.onclick = () => {
    ...
    eraseIngredients( newArray ).then( () => {
...
async function eraseIngredients( jsonObj ) {
